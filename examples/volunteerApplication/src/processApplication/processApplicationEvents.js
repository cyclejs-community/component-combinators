...
import { STEP_REVIEW } from './properties';
import { isBoolean, preventDefault } from '../../../../src/utils';
import {
  STEP_ABOUT,
  USER_APPLICATION_BACK_TO_TEAMS_SELECTOR,
  USER_APPLICATION_ABOUT_CONTINUE_BUTTON_SELECTOR, USER_APPLICATION_JOIN_UNJOIN_TEAM_SELECTOR,
  USER_APPLICATION_REVIEW_ABOUT_SELECTOR, USER_APPLICATION_REVIEW_OPP_QUESTION_SELECTOR,
  USER_APPLICATION_REVIEW_SUBMIT_SELECTOR, USER_APPLICATION_TEAM_CONTINUE_BUTTON_SELECTOR,
  USER_APPLICATION_REVIEW_TEAMS_SELECTOR,
