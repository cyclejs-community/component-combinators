# Resources addressing firebase authentication 

## Contents
1. An example (with demo website) covering :
- the 6 types of authentication managed by `firebase` (facebook, google, twitter, by email/password etc.)
 - together with authentication management (email address verification, email address change, password reset etc.)

2. Firebase configuration steps
- cf. [Create custom email action handlers](https://firebase.google.com/docs/auth/custom-email-handler)
- cf. [Customize account management emails](https://support.google.com/firebase/answer/7000714) 


## Sample code
https://github.com/rhroyston/firebase-auth/blob/master/script.js
